...
top_categories_by_region = top_categories_by_region.groupby(level=0).idxmax()
top_categories_by_region = top_categories_by_region.apply(lambda x: x[1])
...
print("1. Focus on top revenue products like PhoneX.")
print("2. Improve promotion strategy since non-promoted items perform slightly better.")
print("3. Fix missing data in Units and Unit_Price for better accuracy.")